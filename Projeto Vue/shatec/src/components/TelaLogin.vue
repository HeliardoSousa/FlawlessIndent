        ...
        <div class="campos">
            <form id="form">
                <div class="full-box form-group">
                    ...
                    <input type="text" class="form-control" id="email" placeholder="Digite seu login" v-model="login" validade-obrigatorio validade-email>
                </div>
                <div class="full-box form-group">
...
export default {
  ...
  data() {
    return {
      login: "",
      password: "",
      baseURI: "http://localhost:8080/shatec/api/users/login",
    };
  },
  created: function() {
